...
test_evaluator = dict(
    ...
    output_dataset='HOTS',
    output_dir=
    'my_projects/conversion_tests/results/hots_v1/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_hots-v1-512x512/pred_results',
...
visualizer = dict(
    ...
    output_dataset='HOTS',
    save_dir=
    'my_projects/conversion_tests/results/hots_v1/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_hots-v1-512x512/show',
    target_dataset='HOTS_CAT',
    test_dataset='HOTS',
...
work_dir = 'my_projects/conversion_tests/results/hots_v1/bisenetv1_r18-d32-in1k-pre_1xb2-pre-coco-stuff164k-10k_hots-v1-512x512'
